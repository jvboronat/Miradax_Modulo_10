...
const swipeTo = (getTo = "#menu_page") => {
    ...
    if (getTo === "#menu_page") {
        ...
        if (getTo === "#settings_page") {
            swiper.slideTo(0);
        } else {
            if (getTo === "#leaderboard_page") {
                swiper.slideTo(2);
            }
        }
    }
...
const navigationTo = (getTo, animationType) => {
    switch (animationType) {
        ...
        case "menu_to_game":
            animation_menu_to_game(getTo);
            break;

        case "game_out":
            animation_confirm_modal_out(getTo);
            animation_resume_modal(getTo);            
...
const popUpToggle = (getTo, animationType) => {
    switch (animationType) {
        ...
        case "confirm_modal_in":
            animation_confirm_modal_in();

            break;

        case "confirm_modal_out":
            animation_confirm_modal_out();
            animation_resume_modal(getTo);
